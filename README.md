...
{% content-ref url="https://app.gitbook.com/s/s90SVtIdiQ8dmMsqriIa/running-palmito-testnet" %}
[Running Palmito (testnet)](https://app.gitbook.com/s/s90SVtIdiQ8dmMsqriIa/running-palmito-testnet)
{% endcontent-ref %}
