---
description: 'Last Edited: 11 Aug 2026'
icon: file-lines
---
...
Tellor is an open network where anyone can validate, report data, request any data, dispute data, and help settle disputes via staking and fees. These properties uniquely position Tellor for no friction integrations by users or AI agents alike[^12]. Tellor is crypto-economically secure with measurable security and users can layer additional security controls. There is one way make protocols 100% immune to manipulation or capture but security can be layered to meet each users' needs.\
\
...
[^4]: Checkout our ADR 1008 on voting power by group for more information on why validators are not part of it [https://github.com/tellor-io/layer/blob/main/adr/adr1008%20-%20voting%20power%20by%20group.md](https://github.com/tellor-io/layer/blob/main/adr/adr1008%20-%20voting%20power%20by%20group.md)
...
[^6]: More information on Tellor's security can be found here: [https://tellor.io/blog/layer-security-201/](https://tellor.io/blog/layer-security-201/)

[^7]: An open-source disputable values monitor is available

[^8]: Sky (formerly MakerDAO) is one of the longest running DeFi apps and they still employ a one hour delay on their oracle updates. [https://developers.skyeco.com/security/security-measures/security-mechanisms/#oracle-price-delay](https://developers.skyeco.com/security/security-measures/security-mechanisms/#oracle-price-delay)

[^9]: Oracle extractable value

[^10]: Depending on the type of data, this is a best practice for any system using an oracle

[^11]: Hyperliquid validators overwrote and delisted $JELLY when attacked last year. This works well for protocols with this level of ownership and fair disclosure to their users [https://rekt.news/hyperliquidate2](https://rekt.news/hyperliquidate2)
