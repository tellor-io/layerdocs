...
_**Take a moment to check that****&#x20;****`enable = true`****&#x20;****, and check that your****&#x20;****`rpc_servers`****,****&#x20;****`trust_height`****&#x20;****, and****&#x20;****`trust_hash`****&#x20;****are configured using the steps shown in**_[ _**Node Setup**_](README.md)_**. (be careful to choose the tabs that match your system)**_
