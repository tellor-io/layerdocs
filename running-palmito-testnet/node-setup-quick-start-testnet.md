...
{% tabs %}
{% tab title="Linux" %}
<pre class="language-sh" data-overflow="wrap"><code class="lang-sh"><strong>mkdir -p ~/layer/binaries &#x26;&#x26; cd ~/layer/binaries &#x26;&#x26; mkdir v5.1.1 &#x26;&#x26; cd v5.1.1 &#x26;&#x26; wget https://github.com/tellor-io/layer/releases/download/v5.1.1/layer_Linux_x86_64.tar.gz &#x26;&#x26; tar -xvzf layer_Linux_x86_64.tar.gz
</strong></code></pre>
{% endtab %}
...
```sh
curl -O https://layer-node.com/download/1755540498_mainnet.tar.gz
```
...
{% code overflow="wrap" %}
```sh
tar --no-same-owner --no-same-permissions -xvzf 1755540498_mainnet.tar.gz
```
{% endcode %}
