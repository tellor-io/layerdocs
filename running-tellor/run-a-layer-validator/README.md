...
1\) Change directory to `~/layer/binaries/v6.0.0` and check if your address has funds. You will need to have at least 1 TRB to stake a validator on tellor layer:
